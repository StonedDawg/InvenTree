...
[Release 0.1.4](https://github.com/stoneddawg/InvenTree/releases/tag/0.1.4) (November 2020) provides a number of major new features and improvements, as well as some crucial bug fixes:
