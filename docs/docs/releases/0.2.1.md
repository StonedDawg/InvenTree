...
[Release 0.2.1](https://github.com/stoneddawg/InvenTree/releases/tag/0.2.1) provides a number of major new features and improvements, as well as some crucial bug fixes:

## New Features

### Email Support

[#1304](https://github.com/stoneddawg/InvenTree/pull/1304) adds support for email support. Initially, this is used for sending users emails to perform a password reset
...
[#1417](https://github.com/stoneddawg/InvenTree/pull/1417) adds a new model and
...
[#1462](https://github.com/stoneddawg/InvenTree/pull/1417) adds the ability to
...
| PR | Description |
| --- | --- |
| [#1453](https://github.com/stoneddawg/InvenTree/pull/1453) | Adds *detail* API endpoint for the `PartParameter` model, which was previously missing. |
| [#1478](https://github.com/stoneddawg/InvenTree/pull/1478) | Fixes a bug which exposed database username and password in the log files |
